...
p1 = ggplot(filter(PV_plot, year < 5), aes( (year+1), (Profit/1000), group = Type2, alpha = Type2)) +
  geom_hline(yintercept = 0, alpha = 0.5, lty = 2) + 
  geom_line(aes(color = Type2), size =1) +
  scale_alpha_manual(values = c(rep(1, 2),0.8,rep(1, 2))) +
  scale_y_continuous(breaks = c( seq(0,1200,200))) +
  scale_x_continuous(breaks = c(seq(0,22,1)), expand=c(0,0.5)) +
...
dev.off()
```
>>>>>>> a4d9ea02369f982eee4edf68b310bab64665c28f
