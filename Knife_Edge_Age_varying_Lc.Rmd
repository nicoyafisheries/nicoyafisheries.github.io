...
Lc.Catch = ggplot(Results, aes(x=Lc, y= Total.Catch)) +
              geom_jitter() +
              theme_minimal()
...
Lc.Rev = ggplot(Results, aes(x=Lc, y= Total.Revenue)) +
              geom_jitter() +
              theme_minimal()
...
Lc.price = ggplot(Results, aes(x=Lc, y= (Total.Revenue/Total.Catch))) +
              geom_jitter() +
              theme_minimal()
